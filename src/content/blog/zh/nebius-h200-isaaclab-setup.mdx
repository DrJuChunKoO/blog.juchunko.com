...
import cartpoleWide from "../../../assets/images/openclown/isaaclab-cartpole-4096-wide.jpg";
import cartpoleCloseup from "../../../assets/images/openclown/isaaclab-cartpole-4096.png";
import piperTrajectories from "../../../assets/images/openclown/piper-trajectories.jpg";
import frankaManipulation from "../../../assets/images/openclown/isaaclab-franka-manipulation.jpg";
import piperBirdseye from "../../../assets/images/openclown/piper-envs-4096-birdseye.jpg";
import piperGridOverview from "../../../assets/images/openclown/piper-grid-overview.jpg";
import piperReachCloseup from "../../../assets/images/openclown/piper-ball-reach-closeup.jpg";
import piperReachGripper from "../../../assets/images/openclown/piper-ball-reach-gripper.jpg";
...
<Image src={cartpoleWide} alt="4096 CartPole environments running in parallel on NVIDIA H200 — bird's eye view" style="border-radius: 8px; margin: 1rem 0; width: 100%; height: auto;" />

*鳥瞰全景 — 每個都是獨立的 RL episode。*

近拍可以看到每個 CartPole 的細節：

<Image src={cartpoleCloseup} alt="4096 CartPole environments close-up" style="border-radius: 8px; margin: 1rem 0; width: 100%; height: auto;" />

*拉近看 — 藍色小車在黃色軌道上，深色桿子角度各異。*

<Image src={piperTrajectories} alt="PiPER robot arm end-effector trajectory visualization" style="border-radius: 8px; margin: 1rem 0; width: 100%; height: auto;" />
...
- [x] 截圖 + 錄影 pipeline
<Image src={frankaManipulation} alt="Isaac Lab Franka robot arms performing object manipulation in simulation" style="border-radius: 8px; margin: 1rem 0; width: 100%; height: auto;" />
...
<Image src={piperBirdseye} alt="4096 PiPER robot arm environments running in parallel — bird's eye view" style="border-radius: 8px; margin: 1rem 0; width: 100%; height: auto;" />

*4,096 個 PiPER 手臂環境鳥瞰 — 每個平台上都有一隻手臂和一顆紅球。*

<Image src={piperGridOverview} alt="PiPER training grid overview with thousands of environments" style="border-radius: 8px; margin: 1rem 0; width: 100%; height: auto;" />

*密密麻麻的訓練環境 grid，每個都是獨立的 RL episode。*

近拍可以看到 PiPER 的夾爪正在接近紅球：

<Image src={piperReachCloseup} alt="PiPER robot arm reaching for red ball — close up" style="border-radius: 8px; margin: 1rem 0; width: 100%; height: auto;" />

*PiPER 手臂近拍 — 夾爪對準紅球，準備抓取。*

<Image src={piperReachGripper} alt="PiPER robot arm with gripper open approaching red ball" style="border-radius: 8px; margin: 1rem 0; width: 100%; height: auto;" />
...
<video 
  src="/images/openclown/piper-4096-all.mp4" 
  controls 
  autoPlay 
  muted 
  loop
...
<video 
  src="/images/openclown/piper-4096-zoom.mp4" 
  controls 
  autoPlay 
  muted 
  loop
...
<video 
  src="/images/openclown/piper-training-final.mp4" 
  controls 
  autoPlay 
  muted 
  loop
