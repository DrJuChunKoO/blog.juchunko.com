...
<div style="display: flex; gap: 16px; margin: 24px 0; justify-content: center;">
  <img src="/images/world-id-basemail/dashboard-verified.jpg" alt="Dashboard 顯示 Verified Human" style="width: 45%; border-radius: 12px; border: 1px solid #333;" />
  <img src="/images/world-id-basemail/profile-human-badge.jpg" alt="Profile 頁面的 Human 標章" style="width: 45%; border-radius: 12px; border: 1px solid #333;" />
</div>
