...
import idkitConnect from "../../../assets/images/world-id-basemail/idkit-connect.jpg";
import worldAppApprove from "../../../assets/images/world-id-basemail/world-app-approve.jpg";
import dashboardVerified from "../../../assets/images/world-id-basemail/dashboard-verified.jpg";
import profileHumanBadge from "../../../assets/images/world-id-basemail/profile-human-badge.jpg";
...
<div style="display: flex; gap: 16px; margin: 24px 0; justify-content: center;">
  <Image src={idkitConnect} alt="IDKit 元件：連結你的 World ID" style="width: 45%; border-radius: 12px; border: 1px solid #333; height: auto;" />
  <Image src={worldAppApprove} alt="World App：連結 World ID 到 BaseMail — 已分享" style="width: 45%; border-radius: 12px; border: 1px solid #333; height: auto;" />
</div>
...
<div style="display: flex; gap: 16px; margin: 24px 0; justify-content: center;">
  <Image src={dashboardVerified} alt="Dashboard 顯示 Verified Human" style="width: 45%; border-radius: 12px; border: 1px solid #333; height: auto;" />
  <Image src={profileHumanBadge} alt="Profile 頁面的 Human 標章" style="width: 45%; border-radius: 12px; border: 1px solid #333; height: auto;" />
</div>
