...
![BaseMail Lens Social Graph - Force 模式：614 個帳號、622 個連結的力導向圖譜，可以看到每個節點的頭像和互動關係](../../../assets/images/basemail-lens/lens-graph-tooltip.jpg)
...
![BaseMail Lens Social Graph - 密集的力導向圖譜，538 個帳號形成有機的網路結構](../../../assets/images/basemail-lens/lens-graph-force.jpg)

### 4. 🪐 軌道模式（Orbit View）

切換到 **Orbit 模式**，節點會排列成同心圓——越靠近中心的人跟你的關係越密切：

![BaseMail Lens Social Graph - Orbit 模式：526 個帳號以同心圓排列，形成星球般的視覺效果](../../../assets/images/basemail-lens/lens-graph-orbit.jpg)
