...
![BaseMail Lens Social Graph - Force mode: 614 accounts, 622 connections in a force-directed layout, showing avatar nodes and interaction relationships](/images/basemail-lens/lens-graph-tooltip.jpg)
...
![BaseMail Lens Social Graph - Dense force-directed graph with 538 accounts forming an organic network structure](/images/basemail-lens/lens-graph-force.jpg)

### 4. 🪐 Orbit Mode

Switch to **Orbit mode** and nodes arrange into concentric circles — closer connections orbit near the center:

![BaseMail Lens Social Graph - Orbit mode: 526 accounts arranged in concentric circles, creating a planet-like visual](/images/basemail-lens/lens-graph-orbit.jpg)
