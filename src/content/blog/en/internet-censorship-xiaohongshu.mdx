...
pubDate: "2025-12-07"
heroImage: "../../../assets/images/internet-censorship-xiaohongshu/cover.png"
author: "lin-si-cheng"
categories: ["internet-freedom", "policy-analysis", "legal-issues"]
---

import { Image } from 'astro:assets';
import linSiCheng from "../../../assets/images/lin-si-cheng.jpg";
...
![Illustration of Legal and Tech Restrictions](../../../assets/images/internet-censorship-xiaohongshu/legal-restriction.png)
...
<div class="author-profile">
  <Image src={linSiCheng} alt="Lin Si Cheng" style="width: 150px; border-radius: 50%; float: left; margin-right: 20px; height: auto;" />
  <div>
    <h4>Lin Si Cheng</h4>
