...
<div style="display: flex; gap: 16px; margin: 24px 0; justify-content: center;">
  <img src="/images/world-id-basemail/idkit-connect.jpg" alt="IDKit widget: Connect your World ID" style="width: 45%; border-radius: 12px; border: 1px solid #333;" />
  <img src="/images/world-id-basemail/world-app-approve.jpg" alt="World App: Connect your World ID to BaseMail — Shared" style="width: 45%; border-radius: 12px; border: 1px solid #333;" />
</div>
...
<div style="display: flex; gap: 16px; margin: 24px 0; justify-content: center;">
  <img src="/images/world-id-basemail/dashboard-verified.jpg" alt="Dashboard: Verified Human status" style="width: 45%; border-radius: 12px; border: 1px solid #333;" />
  <img src="/images/world-id-basemail/profile-human-badge.jpg" alt="Profile page with Human badge" style="width: 45%; border-radius: 12px; border: 1px solid #333;" />
</div>
