...
<div style="display: flex; gap: 16px; margin: 24px 0; justify-content: center;">
  <Image src={idkitConnect} alt="IDKit widget: Connect your World ID" style="width: 45%; border-radius: 12px; border: 1px solid #333; height: auto;" />
  <Image src={worldAppApprove} alt="World App: Connect your World ID to BaseMail — Shared" style="width: 45%; border-radius: 12px; border: 1px solid #333; height: auto;" />
</div>
...
<div style="display: flex; gap: 16px; margin: 24px 0; justify-content: center;">
  <Image src={dashboardVerified} alt="Dashboard: Verified Human status" style="width: 45%; border-radius: 12px; border: 1px solid #333; height: auto;" />
  <Image src={profileHumanBadge} alt="Profile page with Human badge" style="width: 45%; border-radius: 12px; border: 1px solid #333; height: auto;" />
</div>
