...
> This post documents the debugging session from the early hours of March 22, 2026, collaborating with local AI Agent [Antigravity](https://antigravity.google/) to fix AgentBook on-chain registration on [CanFly.ai](https://canfly.ai).
