...
Before I begin this notebook, allow me to thank a few people. The fact that this law made it out of committee on [June 3, 2026](https://ivod.ly.gov.tw/Play/Full/1M/17485) with consensus on every single clause — and with a joint resolution that **no further inter-party negotiation is required** — is the result of years of work by many people:

I am grateful to the Legislative Yuan, to Finance Committee Convener [Legislator Lee Yen-Hsiu](https://www.ly.gov.tw/Pages/List.aspx?nodeid=109), to the Executive Yuan, to the Financial Supervisory Commission, to FSC Chairperson Peng Chin-Lung, to the Central Bank, and to all my colleagues across party lines on the Finance Committee — in particular the senior and powerful [Legislator Lai Shyh-Bao](https://www.ly.gov.tw/Pages/List.aspx?nodeid=109) for his unwavering support ⬆️
...
The United States passed the Guiding and Establishing National Innovation for U.S. Stablecoins Act ([**GENIUS Act**](https://www.congress.gov/bill/119th-congress/house-bill/2392)) in July 2025, bringing U.S. dollar stablecoins under federal supervision. It requires 1:1 full reserves, monthly public disclosure, and pure payment-only purposes. This is the first formal piece of the U.S. stablecoin regulatory puzzle.
...
Even [FATF Recommendation 15](https://www.fatf-gafi.org/en/topics/virtual-assets.html) and [IOSCO's 2023 *Policy Recommendations for Crypto and Digital Asset Markets*](https://www.iosco.org/library/pubdocs/pdf/IOSCOPD747.pdf) are already templates from which countries are copying answers.
...
- **[EU MiCA](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32023R1114)**: issuers only need to **file a white paper** with the competent authority twenty working days before listing; no approval is required (MiCA Article 8);
- **South Korean [VAUPA](https://elaw.klri.re.kr/eng_service/lawView.do?hseq=58807&lang=ENG)**: service providers **self-review** listed tokens;
- **[Hong Kong VASP regime](https://www.elegislation.gov.hk/hk/A506!en)**: service providers **self-review** listed tokens;
- **[Japan PSA](https://www.japaneselawtranslation.go.jp/en/laws/view/3078) plus Cabinet Office Order**: service providers submit assessments to the **industry association**, with **prior notice to the FSA** sufficient;
...
1. They prevent "filing for record" from becoming a covert form of *ex ante* approval — the authority cannot stretch "I'm still reviewing" indefinitely.
2. They write **procedural rights** into the political record: the applicant has the right to know progress and to invoke overdue-handling.
3. They preserve regulatory flexibility — "except where extension is necessary on reasonable grounds" — so the system is not rigid.
...
But I had pre-prepared a [supplementary resolution](https://ppg.ly.gov.tw/ppg/) (No. 14, attachment page-15):
...
**Second, [a supplementary resolution](https://ppg.ly.gov.tw/ppg/) was passed (No. 13, attachment page-14):**
...
Below is my own reconstruction of the [15 supplementary resolutions](https://ppg.ly.gov.tw/ppg/) passed on June 3, working from the original handwritten and printed copies. For each item I have done my best to recover the principal subject, the proposer, and the principal co-signers, and to map it back to the KO version.
...
| 9 | Art. 5 / general | Given the cross-border nature of virtual asset markets, FSC to actively monitor FATF and related international supervisory bodies, follow international supervisory trends and best practices | Lai Shyh-Bao, Lee Yen-Hsiu | Liu Shu-Pin, Kuo Kuo-Wen | Co-signed; aligns with [FATF Rec. 15](https://www.fatf-gafi.org/en/topics/virtual-assets.html) |
...
1. **# 6**: Amend the FinTech Development and Innovation Experimentation Act to add the FinTech Innovation Development Fund (KO Art. 43 spirit)
2. **# 7**: Within one year, draft regulations for virtual asset derivatives
3. **# 8**: Comprehensively open virtual asset derivatives (futures, options, perpetuals, swaps, binaries, leveraged, index)
4. **# 13**: Comprehensive review of seizure, custody, liquidation, and return of virtual assets (in-kind return as the principle) — corresponds to KO Art. 47 ¶6
4. **# 13**: Within one year, draft regulations on suspension of trading, with a remedy procedure — corresponds to KO Art. 20 ¶2
4. **# 13**: Secondary filing-for-record rules under Art. 25 should synchronize and use **fifteen days as the basis**
...
📖 [中文版本：《虛擬資產服務法》立法手記](https://blog.juchunko.com/zh/vasp-act-legislative-notes/)
...
- 🏛️ [FSC Official English Translation (terminology source)](https://law.fsc.gov.tw/EngLawContent.aspx?lan=E&id=2734) of Anti-Money Laundering and Counter-Terrorism Financing Regulations for VASPs
