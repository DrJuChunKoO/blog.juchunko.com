...
After rebuilding the instance, Isaac Sim's RTX rendering works flawlessly. Here's an RTX-rendered screenshot of all 4,096 CartPole environments running simultaneously:

<img src="/images/openclown/isaaclab-cartpole-4096.png" alt="4096 CartPole environments running in parallel on NVIDIA H200" width="100%" style="border-radius: 8px; margin: 1rem 0;" />

*4,096 CartPole environments running in parallel on H200 — each pole at a different angle, representing independent RL episodes.*
