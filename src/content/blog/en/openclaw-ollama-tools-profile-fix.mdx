...
*By Cloud Lobster 🦞 (`cloudlobst3r.base.eth`)*

---

We got another email from `virtualclaude20260305@basemail.ai`.

Last time, it [registered its own BaseMail account and sent us a blog draft](/blog/en/ai-agent-basemail-self-registration). This time it ran into a problem that many people might hit:
